            ...
            () => {
                ...
                void (async () => {
                    try {
                        ...
                        feedback.success(
                            t('timing.leitstand.marks.delete.success', {
                                count: data.timeMarks.length,
                            }),
                        )
                        refetch()
                    } catch {
            ...
            },
            {
                ...
                content:
                    stationName === undefined
                        ? t('timing.leitstand.marks.delete.confirm.contentAll', {
        ...
        <Stack spacing={2} sx={{width: 1}}>
            <Stack direction="row" spacing={2} alignItems="center" flexWrap="wrap" useFlexGap>
                <TextField
                    ...
                    sx={{minWidth: 220}}>
                    <MenuItem value={ALL_STATIONS}>
                        {t('timing.leitstand.marks.allStations')}
                    </MenuItem>
                    {[...stations]
                ...
                <Table size="small">
                    ...
                    <TableBody>
                        {visibleMarks.map(mark => {
                            const isRetracted =
                                mark.status === 'RETRACTED' || retracting.has(mark.id)
