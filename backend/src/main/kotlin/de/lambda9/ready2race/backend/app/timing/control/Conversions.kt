...
/**
 * The [Timecode] to persist for a measured time of [measuredMillis].
 *
 ...
 * millisecond-exact.
 */
fun measuredTimecode(measuredMillis: Long): Timecode {
    val baseUnit = when {
        measuredMillis >= 3_600_000 -> Timecode.BaseUnit.HOURS
        measuredMillis >= 60_000 -> Timecode.BaseUnit.MINUTES
        else -> Timecode.BaseUnit.SECONDS
    }
    val rendered = Timecode(measuredMillis, baseUnit, Timecode.MillisecondPrecision.THREE).toString()
